...
output: 
  flexdashboard::flex_dashboard:
    ...
    social: menu
    navbar:
        - { icon: "fa-github", href: "https://github.com/schoulten/ipcaforecasting", align: right }
...
<br>
I am an economist passionate about macroeconomics with 3 years of experience in analyzing the economic scenario. I do data analysis with time series and microdata using the power of R for automation. My work helps people to understand the economic scenario and make decisions.<br>
<br>
**Website**: <https://fortietwo.com/><br>
**GitHub**: <https://www.github.com/schoulten><br>
**LinkedIn**: <https://www.linkedin.com/in/schoulten/><br>
<br>
